...
private:
	...
	int degree[10001]; // degree[hash(str)] = degree(str)
	int offsetID[10001]; // offsetID[hash(str)] = ID(str)
	int offsetInverse[10001]; //offsetInverse[offsetID] = offset;
	int length[10001]; //record the length of str[i]
	int hashIndex;
	string SENTRY;
